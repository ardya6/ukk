                        ...
                        <div class="card">
                            ...
                            <div class="wow fadeIn" data-wow-delay="0.5s">
                                    ...
                                    <div class="product_details_text">
                                        @csrf
                                        <a href=""><img class="img-fluid"  style="height: 300px; object-fit: cover"  src="{{ asset('storage/'.$checkout->detailruangan->foto) }}" alt=""></a>
                                    ...
                                    <table class="table">  
                                        <div class="col-lg-8 mt-5 align-item-center ">
                                            <div class="card-title">
                                                <h3 class="text-center">detail checkout</h3>
                                            </div>
