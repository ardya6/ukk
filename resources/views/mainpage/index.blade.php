    ...
    <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
        ...
        <div class="container-xxl py-5">
            <div class="container">
                ...
                <div class="row g-4">
                    <div class="col-lg-3 col-sm-6 wow d-flex w-100 fadeInUp" data-wow-delay="0.1s">
                        @foreach ($kategoris as $kategori)
                        <a class="cat-item d-block bg-light text-center rounded p-3" href="/list/{{ $kategori->id }}">
