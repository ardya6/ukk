...
<div class="modal fade" id="ratingModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header d-flex justify-content-end"><button class="btn btn-secondary" type="button"
                    data-bs-dismiss="modal"><i class="fa fa-times" aria-hidden="true"></i></button>
            </div>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="/rating" class="text-center">
                                        ...
                                        <h4 class="mt-1 text-dark">Nilai Ruangan</h4>
